	...
	<div class="container-fluid">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <div class="row">            
                    <div class="col-md-2 textalignl pad-b-5" >                        
                        <button class="btn btn-primary" id="btnInsertTag" value="au" type="button" onclick="change_TxtColor(this);">insert Tag</button>                        
                    </div>
                    <div class="col-md-2 textalignl pad-b-5">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <div class="row pad-10">            
                    ...
                    <div class="col-md-12 pad-10" style="background: #ffffff !important; overflow:scroll; height:400px;">
                        <xmp id="ptxaxml" > </xmp>
                        &nbsp;&nbsp;
                    </div>
                </div>
