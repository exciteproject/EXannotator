<html>
<head>
<script src="var/www/html/anno/scripts.js" type="text/javascript"></script>
</head>
<body>
		...
		<input type="file" accept=".txt"  id="rsf" style="display: none;" name="ReferenceStringsFile" value="ReferenceStringsFile" onchange="fileNameB1(); loadFileAsText1();"/>
		...
		<input type="file" accept=".xml" id="trs" style="display: none;" name="TaggedReferenceStrings" value="TaggedReferenceStrings" id="trs" onchange="fileNameB2(); loadFileAsText2();"/>
		...
		<textarea id="ta2" cols="80" rows="7"></textarea> <br>
		
		<button type="button" onclick="prevElement();">Previous</button>
		<label id="count" style="padding-left:5px; padding-right:5px;"> 0/0 </label>
		<button type="button" onclick="nextElement();">Next</button>
